...
app.post("/webhook", async (req, res) => {
    ...
    if ((message === null || message === void 0 ? void 0 : message.type) === "text") {
        ...
        if (messageBody.toLowerCase() == "hi" ||
            ...
            const result = await (0, wp_message_1.default)(grammer_check_1.grammerCheckFlow, messageBody);
            await (0, wp_message_1.sendWAMessage)(business_phone_number_id, messageFrom, result.message);
            const userData = {
                message: messageBody,
