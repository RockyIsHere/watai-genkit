...
const bengali_poem_1 = require("./actions/bengali.poem");
            ...
            if (userData && businessPhoneNumberId) {
                ...
                switch (userData.conversationId) {
                    ...
                    case "paraphraser":
                        ...
                        break;
                    case "synonyms":
                        result = (await (0, wp_message_1.default)(synonyms_1.synonymsFlow, messageBody)).message;
                        break;
                    case "antonyms":
                        result = (await (0, wp_message_1.default)(antonyms_1.antonymsFlow, messageBody)).message;
                        break;
                    case "english_poem":
                        ...
                        break;
                    case "quotes":
                        result = (await (0, wp_message_1.default)(quotes_1.quotesFlow, messageBody))
                            .message;
                        break;
...
app.post("/generate", async (req, res) => {
    ...
    try {
        const result = (await (0, wp_message_1.default)(bengali_poem_1.bengaliPoemFlow, input)).message;
