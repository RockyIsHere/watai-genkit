...
app.post("/db", async (req, res) => {
    ...
    await (0, tamplate_1.default)("917029406424");
...
app.post("/webhook", async (req, res) => {
    ...
    if ((message === null || message === void 0 ? void 0 : message.type) === "text") {
        ...
        const result = await (0, wp_message_1.default)(grammer_check_1.grammerCheckFlow, message.text.body);
        await (0, wp_message_1.sendWAMessage)(business_phone_number_id, message.from, result.message);
        const userData = {
